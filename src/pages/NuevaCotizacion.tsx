          ...
          <CardBody>
            <div className="flex flex-col gap-2 text-right">
              <div className="text-sm">
                <span className="font-medium">Subtotal:</span>
                <span className="ml-2">
                  {formData.subtotal.toLocaleString('es-MX', { style: 'currency', currency: 'MXN' })}
                </span>
              </div>
              <div className="text-sm">
                <span className="font-medium">IVA:</span>
                <span className="ml-2">
                  {formData.iva.toLocaleString('es-MX', { style: 'currency', currency: 'MXN' })}
                </span>
              </div>
              <div className="text-lg font-semibold">
                <span>Total:</span>
                <span className="ml-2">
                  {formData.total.toLocaleString('es-MX', { style: 'currency', currency: 'MXN' })}
                </span>
              </div>
            </div>
          </CardBody>
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody>
                ...
                >
                  <SelectItem key="empty" value="">Seleccionar cliente</SelectItem>
